...
namespace SharpOcarina
{
    ...
    public partial class MainForm : Form
    {
        ...
        private void DrawActorModel(ZActor Actor, Color FillColor, int DrawModelGLID, bool DrawAxis, bool DrawBorder, bool Actorpick = false)
        {
            ...
            for (int j = 0; j < 2; j++)
            {
                ...
                if (j == 1)
                {
                    if (DrawBorder)
                    {
                        ...
                        if (Actorpick && DrawAxis)
                            GL.Color4(Color.Yellow.R, Color.Yellow.G, Color.Yellow.B, 1.0f);
                        else
            ...
            for (int j = 0; j < 2; j++)
            {
                ...
                if (j == 1)
                {
                    if (DrawBorder)
                    {
                        GL.PolygonMode(MaterialFace.FrontAndBack, PolygonMode.Line);
                        if (Actorpick && DrawAxis)
                            GL.Color4(Color.Red.R, Color.Red.G, Color.Red.B, 1.0f);
                        else
                            GL.Color4(Color.Black.R, Color.Black.G, Color.Black.B, 1.0f);
        ...
        private void DrawCameraPoint(Vector3 CameraPoint, Vector3 NextCameraPoint, Vector3 CameraPoint2, int DrawModelGLID, byte SelectedCameraPoint, bool Actorpick = false)
        {
            GL.PushMatrix();
            ...
            for (int j = 0; j < 2; j++)
            {
                ...
                {
                    GL.PolygonMode(MaterialFace.FrontAndBack, PolygonMode.Line);
                    if (Actorpick && SelectedCameraPoint != 0)
                        GL.Color4(Color.Yellow.R, Color.Yellow.G, Color.Yellow.B, 1.0f);
                    else
                        GL.Color4(Color.Black.R, Color.Black.G, Color.Black.B, 1.0f);
            ...
            if (SelectedCameraPoint == 1 && Actorpick && settings.DisplayAxis)
                GL.CallList(AxisMarkerGLID);
            ...
            if (SelectedCameraPoint == 2 && Actorpick && settings.DisplayAxis)
                GL.CallList(AxisMarkerGLID);
        ...
        private void DrawCutsceneActor(Vector3 StartPos, Vector3 EndPos, Vector3 Rotation, int DrawModelGLID, byte SelectedCutsceneActor, bool Actorpick = false)
        {
            GL.PushMatrix();
            ...
            for (int j = 0; j < 2; j++)
            {
                ...
                {
                    GL.PolygonMode(MaterialFace.FrontAndBack, PolygonMode.Line);
                    if (Actorpick && SelectedCutsceneActor != 0)
                        GL.Color4(Color.Yellow.R, Color.Yellow.G, Color.Yellow.B, 1.0f);
                    else
                        GL.Color4(Color.Black.R, Color.Black.G, Color.Black.B, 1.0f);
            ...
            if (SelectedCutsceneActor == 1 && Actorpick && settings.DisplayAxis)
                GL.CallList(AxisMarkerGLID);
            ...
            if (SelectedCutsceneActor == 2 && Actorpick && settings.DisplayAxis)
                GL.CallList(AxisMarkerGLID);
        ...
        private void DrawPointLight(ZAdditionalLight Light, Color FillColor, int DrawModelGLID, bool DrawAxis, bool DrawBorder, bool Actorpick = false)
        {
            GL.PushMatrix();
        ...
        private void DrawFixedCamera(ZCamera Camera, Color FillColor, int DrawModelGLID, bool DrawAxis, bool DrawBorder, bool Actorpick = false)
        {
            List<Vector3h> Positions = new List<Vector3h>();
            Positions.Add(new Vector3h(Camera.XPos,Camera.YPos,Camera.ZPos));

            if (!settings.MajorasMask && Camera.Type == 0x1E)
            {
                Positions.Add(new Vector3h(Camera.XRot, Camera.YRot, Camera.ZRot));
                if (settings.SixPointCrawlSpace)
                {
                    Positions.Add(new Vector3h(Camera.Fov, (short)Camera.Unk1, (short)Camera.Unk2));
                    Positions.Add(new Vector3h((short)Camera.Unk12, (short)Camera.Unk14, (short)Camera.Unk16));
                    Positions.Add(new Vector3h((short)Camera.Unk18, (short)Camera.Unk1A, (short)Camera.Unk1C));
                    Positions.Add(new Vector3h((short)Camera.Unk1E, (short)Camera.Unk20, (short)Camera.Unk22));
                }
            }
            int c = 0;
            foreach (Vector3h position in Positions)
            {
                ...
                if (c > 0)
                {
                    ...
                    GL.Vertex3(Positions[c - 1].X, Positions[c - 1].Y, Positions[c - 1].Z);
                    GL.End();
                ...
                if (FillColor.R == 255)
                    GL.Color4(Color.FromArgb(255, FillColor.R - 5 + c, FillColor.G, FillColor.B));
                else
                    GL.Color4(FillColor);
                ...
                for (int j = 0; j < 2; j++)
                {
                    ...
                    if (j == 1)
                    {
                        ...
                        {
                            GL.PolygonMode(MaterialFace.FrontAndBack, PolygonMode.Line);
                            if (Actorpick && DrawAxis && extrapick == c)
                                GL.Color4(Color.Yellow.R, Color.Yellow.G, Color.Yellow.B, 1.0f);
                            else
                                GL.Color4(Color.Black.R, Color.Black.G, Color.Black.B, 1.0f);
                ...
                if (DrawAxis && Actorpick && settings.DisplayAxis && c == 0)
                    GL.CallList(AxisMarkerGLID);
        ...
        public void PaintControl()
        {
            ...
            if (CurrentScene != null && NowLoading == false)
            {
                ...
                if (CurrentScene.Environments.Count != 0 && (int)EnvironmentSelect.Value >= 0)
                {
                    ...
                    //GL.Arb.ProgramEnvParameter4(AssemblyProgramTargetArb.FragmentProgram, 0, CurrentScene.Environments[(int)EnvironmentSelect.Value].C2C.R / 255f, CurrentScene.Environments[(int)EnvironmentSelect.Value].C2C.G / 255f, CurrentScene.Environments[(int)EnvironmentSelect.Value].C2C.B / 255f, CurrentScene.Environments[(int)EnvironmentSelect.Value].C2C.A / 255f);
                    /*
                    GL.Light(LightName.Light1, LightParameter.Diffuse, Color.FromArgb(
                        CurrentScene.Environments[(int)EnvironmentSelect.Value].C4C.A,
                        CurrentScene.Environments[(int)EnvironmentSelect.Value].C4C.R,
                        CurrentScene.Environments[(int)EnvironmentSelect.Value].C4C.G,
                        CurrentScene.Environments[(int)EnvironmentSelect.Value].C4C.B));
                        */
                    ...
                    if (Room == CurrentScene.Rooms[RoomList.SelectedIndex])
                    {
                        ...
                        for (int i = 0; i < Room.ZActors.Count; i++)
                        {
                            DrawActorModel(Room.ZActors[i],
                                (i == actorEditControl.ActorNumber ? Color.FromArgb(0, 255, 0) : Color.FromArgb(192, 255, 192)),
                                ActorCubeGLID,
                                i == actorEditControl.ActorNumber, true, actorpick == _Actor_);
                        }
                        ...
                        for (int i = 0; i < Room.AdditionalLights.Count; i++)
                        {
                            if (Room.AdditionalLights[i].PointLight)
                            {
                                DrawPointLight(Room.AdditionalLights[i],
                                    ...
                                    ActorCubeGLID,
                                    Convert.ToBoolean(i == AdditionalLightSelect.Value - 1), true, actorpick == _AddLight_);
                            }
                        }
                    }
                ...
                for (int i = 0; i < CurrentScene.SpawnPoints.Count; i++)
                    DrawActorModel(CurrentScene.SpawnPoints[i],
                        (i == spawnerEditControl.ActorNumber ? Color.FromArgb(0, 0, 255) : Color.FromArgb(192, 192, 255)),
                        ActorPyramidGLID,
                        Convert.ToBoolean(i == spawnerEditControl.ActorNumber), true, actorpick == _Spawn_);

                /* Render transition actors... */
                for (int i = 0; i < CurrentScene.Transitions.Count; i++)
                    DrawActorModel(CurrentScene.Transitions[i],
                        (i == transitionEditControl.ActorNumber ? Color.FromArgb(255, 0, 0) : Color.FromArgb(255, 192, 192)),
                        ActorPyramidGLID,
                        Convert.ToBoolean(i == transitionEditControl.ActorNumber), true, actorpick == _Transition_);
                ...
                for (int i = 0; i < CurrentScene.Pathways.Count; i++)
                {
                    for (int ii = 0; ii < CurrentScene.Pathways[i].Points.Count; ii++)
                    {
                        ...
                        DrawPathway(CurrentScene.Pathways[i].Points[ii], NextVector,
                            ...
                            Convert.ToBoolean(i == PathwayNumber.Value), actorpick == _Pathway_);
                    }
                }
                ...
                for (int i = 0; i < CurrentScene.Cameras.Count; i++)
                    DrawFixedCamera(CurrentScene.Cameras[i],
                        ...
                        ActorPyramidGLID,
                        Convert.ToBoolean(i == CameraSelect.Value), true, actorpick == _Camera_);
                        ...
                        if (((!settings.MajorasMask) && CurrentScene.Cutscene[i].Marker == 0x01 || CurrentScene.Cutscene[i].Marker == 0x05) || (settings.MajorasMask && CurrentScene.Cutscene[i].Marker == 0x5A)) // if its camera position list
                        {
                            for (int ii = 0; ii < CurrentScene.Cutscene[i].Points.Count; ii++)
                            {
                                ...
                                DrawCameraPoint(CurrentScene.Cutscene[i].Points[ii].Position, NextVector, CurrentScene.Cutscene[i].Points[ii].Position2,
                                    ActorPyramidGLID,
                                    selected, actorpick == _CutsceneCamera_);
                    ...
                    foreach (ZWaterbox WBox in CurrentScene.Waterboxes)
                    {
                        ...
                        for (int i = 0; i < 2; i++)
                        {
                            ...
                            else
                            {
                                ...
                                if (actorpick == _Waterbox_ && incr == (int)WaterboxSelect.Value)
                                    GL.Color4(Color.Yellow.R, Color.Yellow.G, Color.Yellow.B, 1.0f);
                                else
                                    GL.Color4(Color.Black.R, Color.Black.G, Color.Black.B, 1.0f);
                            }
        ...
        void glControl1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.F && CurrentScene != null && CurrentScene.Rooms.Count > 0)
            {
                ...
                if (actorpick == _Actor_ && CurrentScene.Rooms[RoomList.SelectedIndex].ZActors.Count > 0)
                    truepos = new Vector3d(CurrentScene.Rooms[RoomList.SelectedIndex].ZActors[actorEditControl.ActorNumber].XPos, CurrentScene.Rooms[RoomList.SelectedIndex].ZActors[actorEditControl.ActorNumber].YPos, CurrentScene.Rooms[RoomList.SelectedIndex].ZActors[actorEditControl.ActorNumber].ZPos);
                else if (actorpick == _Transition_ && CurrentScene.Transitions.Count > 0)
                    truepos = new Vector3d(CurrentScene.Transitions[transitionEditControl.ActorNumber].XPos, CurrentScene.Transitions[transitionEditControl.ActorNumber].YPos, CurrentScene.Transitions[transitionEditControl.ActorNumber].ZPos);
                else if (actorpick == _Spawn_ && CurrentScene.SpawnPoints.Count > 0)
                    truepos = new Vector3d(CurrentScene.SpawnPoints[spawnerEditControl.ActorNumber].XPos, CurrentScene.SpawnPoints[spawnerEditControl.ActorNumber].YPos, CurrentScene.SpawnPoints[spawnerEditControl.ActorNumber].ZPos);
            ...
            if (KeysDown[(int)Keys.Delete] && CurrentScene != null && CurrentScene.Rooms.Count > 0)
            {
                if (actorpick == _Actor_)
                    actorEditControl.DeleteActor();
                else if (actorpick == _Transition_)
                    transitionEditControl.DeleteActor();
                else if (actorpick == _Spawn_)
                    spawnerEditControl.DeleteActor();
        ...
        void glControl1_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == ActorControlKeys[GKey] && CurrentScene != null && CurrentScene.Rooms.Count > 0)
            {
                ...
                if (prevactorpick != -1)
                {
                    actorpick = prevactorpick;
                    prevactorpick = -1;
                }

                if (tmp == _Actor_) actorEditControl.UpdateActorEdit();
                else if (tmp == _Transition_) transitionEditControl.UpdateActorEdit();
                else if (tmp == _Spawn_) spawnerEditControl.UpdateActorEdit();
                UpdateForm();
        ...
        void glControl1_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (Mouse.RDown && CurrentScene != null && CurrentScene.Rooms.Count > 0)
            {
                ...
                if (Control.ModifierKeys != Keys.Control)
                {
                    ...
                    {
                        if (i != actorEditControl.ActorNumber || actorpick != _Actor_)
                        {
                            ...
                            {
                                selected = true;
                                actorEditControl.ActorComboBox.SelectedIndex = i;
                    ...
                    if (!selected)
                    {
                        ...
                        for (int i = 0; i < CurrentScene.Transitions.Count; i++)
                        {
                            if (i != transitionEditControl.ActorNumber || actorpick != _Transition_)
                            {
                                DrawActorModel(CurrentScene.Transitions[i],
                                ...
                                {
                                    selected = true;
                                    transitionEditControl.ActorComboBox.SelectedIndex = i;
                    ...
                    if (!selected)
                    {
                        ...
                        for (int i = 0; i < CurrentScene.SpawnPoints.Count; i++)
                        {
                            if (i != spawnerEditControl.ActorNumber || actorpick != _Spawn_)
                            {
                                DrawActorModel(CurrentScene.SpawnPoints[i],
                                ...
                                {
                                    selected = true;
                                    spawnerEditControl.ActorComboBox.SelectedIndex = i;
                    ...
                    if (!selected)
                    {
                        ...
                        for (int i = 0; i < CurrentScene.Pathways.Count && !selected; i++)
                        {
                            for (int ii = 0; ii < CurrentScene.Pathways[i].Points.Count; ii++)
                            {
                                if (i != PathwayNumber.Value || ii != PathwayListBox.SelectedIndex || actorpick != _Pathway_)
                                {
                    ...
                    if (!selected)
                    {
                        ...
                        {
                            if ((i != AdditionalLightSelect.Value - 1 || actorpick != _AddLight_) && CurrentScene.Rooms[RoomList.SelectedIndex].AdditionalLights[i].PointLight)
                            {
                            ...
                            for (int i = 0; i < CurrentScene.Cutscene.Count; i++)
                            {
                                ...
                                if ((!settings.MajorasMask && CurrentScene.Cutscene[i].Marker == 0x01) || (settings.MajorasMask && CurrentScene.Cutscene[i].Marker == 0x5A)) // if its camera position list
                                {
                                    ...
                                    for (int ii = 0; ii < CurrentScene.Cutscene[i].Points.Count; ii++)
                                    {
                                        ...
                                        DrawCameraPoint(CurrentScene.Cutscene[i].Points[ii].Position, NullVector, CurrentScene.Cutscene[i].Points[ii].Position2,
                                            ActorPyramidGLID,
                                            sel);
                    ...
                    if (!selected)
                    {
                        ...
                        for (int i = 0; i < CurrentScene.Cameras.Count; i++)
                        {
                            ...
                            if (pixel[0] >= 250)
                            {
                                if (i == CameraSelect.Value && actorpick == _Camera_ && actorpick == (byte)(pixel[0] - 250)) continue;
                                selected = true;
                                CameraSelect.Value = i;
                                UpdateForm();
                                actorpick = _Camera_;
                                extrapick = (byte) (pixel[0] - 250);
                                break;
                            }
                    ...
                    if (!selected && ((settings.OnlyRenderWaterboxesGeneral && tabControl1.SelectedIndex == 0) || !settings.OnlyRenderWaterboxesGeneral))
                    {
                        ...
                        foreach (ZWaterbox WBox in CurrentScene.Waterboxes)
                        {
                            if (incr != (int)WaterboxSelect.Value || actorpick != _Waterbox_)
                            {
                                GL.PushMatrix();
                                GL.Translate(WBox.XPos, WBox.YPos, WBox.ZPos);
        ...
        void GrabingActor()
        {
            ...
            if (GrabDown() && CurrentScene != null && CurrentScene.Rooms.Count > 0)
            {
                ...
                prevactorpick = actorpick;

                actorpick = -1;

                if (CurrentScene.Rooms[RoomList.SelectedIndex].ZActors.Count > 0 && actorEditControl.ActorNumber != -1)
                {
                    DrawActorModel(CurrentScene.Rooms[RoomList.SelectedIndex].ZActors[actorEditControl.ActorNumber],
                        Color.FromArgb(255, 0, 0),
                        ActorCubeGLID,
                        false, false);
                ...
                if (actorpick == -1 && CurrentScene.Transitions.Count > 0 && transitionEditControl.ActorNumber != -1)
                {
                    DrawActorModel(CurrentScene.Transitions[transitionEditControl.ActorNumber],
                        Color.FromArgb(255, 0, 0),
                        ActorPyramidGLID,
                        false, false);
                ...
                if (actorpick == -1 && CurrentScene.SpawnPoints.Count > 0 && spawnerEditControl.ActorNumber != -1)
                {
                    DrawActorModel(CurrentScene.SpawnPoints[spawnerEditControl.ActorNumber],
                        Color.FromArgb(255, 0, 0),
                        ActorPyramidGLID,
                        false, false);
                ...
                if (actorpick == -1 && (ModifierKeys & Keys.Control) != 0) actorpick = prevactorpick;
                ...
                if (actorpick != -1) prevactorpick = actorpick;
        ...
        void glControl1_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            if (GrabDown() && CurrentScene != null && CurrentScene.Rooms.Count > 0 && actorpick != -1)
            {
                ...
                Object target = null;
                if (actorpick == _Actor_ && actorEditControl.ActorNumber > -1 && actorEditControl.ActorNumber < CurrentScene.Rooms[RoomList.SelectedIndex].ZActors.Count)
                    target = CurrentScene.Rooms[RoomList.SelectedIndex].ZActors[actorEditControl.ActorNumber];
                else if (actorpick == _Transition_)
                    target = CurrentScene.Transitions[transitionEditControl.ActorNumber];
                else if (actorpick == _Spawn_)
                    target = CurrentScene.SpawnPoints[spawnerEditControl.ActorNumber];
                else if (actorpick == _Pathway_ && PathwayListBox.SelectedIndex != -1)
                ...
                else if (actorpick == 9)
                {
                    switch(extrapick)
                    {
                        ...
                        case 1:
                        {
                            objpos = new Vector3d(((ZCamera)target).XRot,
                            ((ZCamera)target).YRot,
                            ((ZCamera)target).ZRot);
                            break;
                        }
                        case 2:
                        {
                            objpos = new Vector3d(((ZCamera)target).Fov,
                            (short)((ZCamera)target).Unk1,
                            (short)((ZCamera)target).Unk2);
                            break;
                        }
                        case 3:
                        {
                            objpos = new Vector3d((short)((ZCamera)target).Unk12,
                            (short)((ZCamera)target).Unk14,
                            (short)((ZCamera)target).Unk16);
                            break;
                        }
                        case 4:
                        {
                            objpos = new Vector3d((short)((ZCamera)target).Unk18,
                            (short)((ZCamera)target).Unk1A,
                            (short)((ZCamera)target).Unk1C);
                            break;
                        }
                        case 5:
                        {
                            objpos = new Vector3d((short)((ZCamera)target).Unk1E,
                            (short)((ZCamera)target).Unk20,
                            (short)((ZCamera)target).Unk22);
                            break;
                        }
                    }
                ...
                else if (actorpick == 9)
                {
                    ...
                    switch (extrapick)
                    {
                        ...
                        case 1:
                            {
                                ((ZCamera)target).XRot = (short)objpos.X;
                                ((ZCamera)target).YRot = (short)objpos.Y;
                                ((ZCamera)target).ZRot = (short)objpos.Z;
                                break;
                            }
                        case 2:
                            {
                                ((ZCamera)target).Fov = (short)objpos.X;
                                ((ZCamera)target).Unk1 = (ushort)((short)objpos.Y & 0xFFFF);
                                ((ZCamera)target).Unk2 = (ushort)((short)objpos.Z & 0xFFFF);
                                break;
                            }
                        case 3:
                            {
                                ((ZCamera)target).Unk12 = (ushort)((short)objpos.X & 0xFFFF);
                                ((ZCamera)target).Unk14 = (ushort)((short)objpos.Y & 0xFFFF);
                                ((ZCamera)target).Unk16 = (ushort)((short)objpos.Z & 0xFFFF);
                                break;
                            }
                        case 4:
                            {
                                ((ZCamera)target).Unk18 = (ushort)((short)objpos.X & 0xFFFF);
                                ((ZCamera)target).Unk1A = (ushort)((short)objpos.Y & 0xFFFF);
                                ((ZCamera)target).Unk1C = (ushort)((short)objpos.Z & 0xFFFF);
                                break;
                            }
                        case 5:
                            {
                                ((ZCamera)target).Unk1E = (ushort)((short)objpos.X & 0xFFFF);
                                ((ZCamera)target).Unk20 = (ushort)((short)objpos.Y & 0xFFFF);
                                ((ZCamera)target).Unk22 = (ushort)((short)objpos.Z & 0xFFFF);
                                break;
                            }
                    }
...
//#endif
                    ...
                    transitionEditControl.Enabled = true;
                    spawnerEditControl.Enabled = true;
                    ...
                    if (CurrentScene.Rooms.Count > 0)
                    {
                        ...
                        WindSouth.Value = CurrentScene.Rooms[RoomList.SelectedIndex].WindSouth;
                        WindStrength.Value = CurrentScene.Rooms[RoomList.SelectedIndex].WindStrength;
                        WindVertical.Value = CurrentScene.Rooms[RoomList.SelectedIndex].WindVertical;
                        WindWest.Value = CurrentScene.Rooms[RoomList.SelectedIndex].WindWest;
                        // TimeStart.Text = CurrentScene.Rooms[RoomList.SelectedIndex].StartTime.ToString("X4");
                        TimeSpeed.Value = CurrentScene.Rooms[RoomList.SelectedIndex].TimeSpeed;

                        SoundEcho.Value = CurrentScene.Rooms[RoomList.SelectedIndex].Echo;
                    ...
                    else
                    {
                        ...
                        actorEditControl.Enabled = false;
                    }
        ...
        public void StoreUndo(int datatype, int room = -1)
        {
            ...
            if (datatype == _Actor_)
                ...
                target = CurrentScene.Pathways.ConvertAll(x => (x.Clone()));
            else if (datatype == _Waterbox_)
                target = CurrentScene.Waterboxes.ConvertAll(x => (x.Clone()));
            else if (datatype == _AddLight_)
                target = CurrentScene.Rooms[room].AdditionalLights.ConvertAll(x => (x.Clone()));
            else if (datatype == _CutsceneCamera_)
                target = CurrentScene.Cutscene.ConvertAll(x => (x.Clone()));
            else if (datatype == _CutsceneActor_)
                target = CurrentScene.Cutscene.ConvertAll(x => (x.Clone()));
            else if (datatype == _Camera_)
                target = CurrentScene.Cameras.ConvertAll(x => (x.Clone()));
        ...
        private void Undo(bool Redo = false)
        {
            if ((!Redo && undo.Count > 0) || (Redo && redo.Count > 0))
            {
                ...
                if (undoredo.datatype == _Actor_)
                {
                    ...
                    actorEditControl.SetActors(ref CurrentScene.Rooms[undoredo.room].ZActors);
                ...
                else if (undoredo.datatype == _Spawn_)
                {
                    ...
                    spawnerEditControl.SetActors(ref CurrentScene.SpawnPoints);

                    spawnerEditControl.UpdateActorEdit();
                }
                else if (undoredo.datatype == _Pathway_)
                {
                    target = CurrentScene.Pathways.ConvertAll(pathway => (pathway.Clone()));
                    targetback.Add(new UndoRedo(undoredo.datatype, target, undoredo.room));
                    CurrentScene.Pathways = ((List<ZPathway>)undoredo.data).ConvertAll(pathway => (pathway.Clone()));

                    UpdatePathwayEdit();
                }
                else if (undoredo.datatype == _Waterbox_)
                {
                    target = CurrentScene.Waterboxes.ConvertAll(pathway => (pathway.Clone()));
                    targetback.Add(new UndoRedo(undoredo.datatype, target, undoredo.room));
                    CurrentScene.Waterboxes = ((List<ZWaterbox>)undoredo.data).ConvertAll(x => (x.Clone()));

                    UpdatePathwayEdit();
                }
                else if (undoredo.datatype == _Camera_)
                {
                    target = CurrentScene.Cameras.ConvertAll(camera => (camera.Clone()));
                    targetback.Add(new UndoRedo(undoredo.datatype, target, undoredo.room));
                    CurrentScene.Cameras = ((List<ZCamera>)undoredo.data).ConvertAll(camera => (camera.Clone()));

                    UpdateCameraEdit();
                }
                else if (undoredo.datatype == _AddLight_)
                {
                    SelectRoom(undoredo.room);

                    target = CurrentScene.Rooms[undoredo.room].AdditionalLights.ConvertAll(x => (x.Clone()));
                    targetback.Add(new UndoRedo(undoredo.datatype, target, undoredo.room));
                    CurrentScene.Rooms[undoredo.room].AdditionalLights = ((List<ZAdditionalLight>)undoredo.data).ConvertAll(x => (x.Clone()));

                    UpdateAdditionalLightEdit();
                }
                else if (undoredo.datatype == _CutsceneCamera_ || undoredo.datatype == _CutsceneActor_)
                {
                    target = CurrentScene.Cutscene.ConvertAll(x => (x.Clone()));
                    targetback.Add(new UndoRedo(undoredo.datatype, target, undoredo.room));
                    CurrentScene.Cutscene = ((List<ZCutscene>)undoredo.data).ConvertAll(x => (x.Clone()));
        ...
        private void newSceneToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            actorEditControl.SetUpdateDelegate(TempDelegate);
            actorEditControl.SetLabels("Actor", "Actors");
            actorEditControl.mainform = this;
            actorEditControl.SetSize();

            transitionEditControl.SetUpdateDelegate(TempDelegate);
            transitionEditControl.SetLabels("Transition", "Transitions");
            transitionEditControl.IsTransitionActor = true;
            transitionEditControl.SetSize();
            transitionEditControl.SetActors(ref CurrentScene.Transitions);
            transitionEditControl.mainform = this;

            spawnerEditControl.SetUpdateDelegate(TempDelegate);
            spawnerEditControl.SetLabels("Spawn", "Spawn Points");
            spawnerEditControl.IsSpawnActor = true;
            spawnerEditControl.SetSize();
            spawnerEditControl.SetActors(ref CurrentScene.SpawnPoints);
            spawnerEditControl.mainform = this;
        ...
        private void TrimRom(string rom)
        {
...
//////////////////////////////////////////////////////////////////////////////////
        ...
        private void UpdateWaterboxEdit()
        {
            if (CurrentScene.Waterboxes.Count != 0)
            {
                ...
                WaterboxRoom.Value = (decimal)CurrentScene.Waterboxes[(int)WaterboxSelect.Value].Room;
        ...
        private void UpdateWaterboxData()
        {
            ...
            CurrentScene.Waterboxes[(int)WaterboxSelect.Value].Room = (byte)WaterboxRoom.Value;
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && short.MaxValue - Math.Abs(WaterboxXPos.Value) > 20)
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && short.MaxValue - Math.Abs(WaterboxYPos.Value) > 20)
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && short.MaxValue - Math.Abs(WaterboxZPos.Value) > 20)
        ...
        private void WaterboxSizeX_ChangeValue(object sender, EventArgs e)
        {
            ...
            if (((ModifierKeys & Keys.Shift) != 0) && short.MaxValue - Math.Abs(WaterboxXSize.Value) > 20)
                WaterboxXSize.Value += (WaterboxXSize.Value - (decimal)CurrentScene.Waterboxes[(int)WaterboxSelect.Value].XSize) * 9;
            WaterboxXPos.Value += ((((ModifierKeys & Keys.Shift) != 0)) ? 10 : 1) * (negative);
            UpdateWaterboxData();
        }
        ...
        private void WaterboxSizeY_ChangeValue(object sender, EventArgs e)
        {
            ...
            if (((ModifierKeys & Keys.Shift) != 0) && short.MaxValue - Math.Abs(WaterboxYSize.Value) > 20)
                WaterboxYSize.Value += (WaterboxYSize.Value - (decimal)CurrentScene.Waterboxes[(int)WaterboxSelect.Value].ZSize) * 9;
            WaterboxZPos.Value += ((((ModifierKeys & Keys.Shift) != 0)) ? 10 : 1) * (negative); 
            UpdateWaterboxData();
        }
        ...
        private void UpdateCameraEdit()
        {
            if (CurrentScene.Cameras.Count != 0)
            {
                ...
                CameraUnk1.Value = (short)CurrentScene.Cameras[(int)CameraSelect.Value].Unk1;
                CameraUnk2.Value = (short)CurrentScene.Cameras[(int)CameraSelect.Value].Unk2;
                ...
                if (CurrentScene.Cameras[(int)CameraSelect.Value].Type != 0x1E)
                {
                    ...
                    CameraXRotLabel.Text = "X Rotation:";
                    CameraYRotLabel.Text = "Y Rotation:";
                    CameraZRotLabel.Text = "Z Rotation:";


                    if (settings.SixPointCrawlSpace)
                    {

                        CameraFovLabel.Text = "FOV:";
                        CameraBackgroundLabel.Text = "Background:";
                        CameraUnkLabel.Text = "Unk:";

                        CameraXRot.Increment = CameraXRot.IncrementMouseWheel = 182;
                        CameraYRot.Increment = CameraYRot.IncrementMouseWheel = 182;
                        CameraZRot.Increment = CameraZRot.IncrementMouseWheel = 182;
                    }
                }
                else
                {
                    ...
                    CameraXRotLabel.Text = "X Position 2:";
                    CameraYRotLabel.Text = "Y Position 2:";
                    CameraZRotLabel.Text = "Z Position 2:";
                    ...
                    if (settings.SixPointCrawlSpace)
                    {
                        ...
                        CameraUnk12.Value = (short)CurrentScene.Cameras[(int)CameraSelect.Value].Unk12;
                        CameraUnk14.Value = (short)CurrentScene.Cameras[(int)CameraSelect.Value].Unk14;
                        CameraUnk16.Value = (short)CurrentScene.Cameras[(int)CameraSelect.Value].Unk16;
                        CameraUnk18.Value = (short)CurrentScene.Cameras[(int)CameraSelect.Value].Unk18;
                        CameraUnk1A.Value = (short)CurrentScene.Cameras[(int)CameraSelect.Value].Unk1A;
                        CameraUnk1C.Value = (short)CurrentScene.Cameras[(int)CameraSelect.Value].Unk1C;
                        CameraUnk1E.Value = (short)CurrentScene.Cameras[(int)CameraSelect.Value].Unk1E;
                        CameraUnk20.Value = (short)CurrentScene.Cameras[(int)CameraSelect.Value].Unk20;
                        CameraUnk22.Value = (short)CurrentScene.Cameras[(int)CameraSelect.Value].Unk22;

                        CameraFovLabel.Text = "X3:";
                        CameraBackgroundLabel.Text = "Y3:";
                        CameraUnkLabel.Text = "Z3:";

                        CameraXRot.Increment = CameraXRot.IncrementMouseWheel = 1;
                        CameraYRot.Increment = CameraYRot.IncrementMouseWheel = 1;
                        CameraZRot.Increment = CameraZRot.IncrementMouseWheel = 1;
                    }
                }
            }
            else
        ...
        private void PathwayTransformX_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (((ModifierKeys & Keys.Shift) != 0) && short.MaxValue - Math.Abs(PathwayXPos.Value) > 20)
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && short.MaxValue - Math.Abs(PathwayYPos.Value) > 20)
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && short.MaxValue - Math.Abs(PathwayZPos.Value) > 20)
        ...
        private void AdditionalLightAdd_Click(object sender, EventArgs e)
        {
            ...
            if (((ModifierKeys & Keys.Shift) != 0))
            {
                ...
                CurrentScene.Rooms[RoomList.SelectedIndex].AdditionalLights.Add(new ZAdditionalLight((short)truepos.X, (short)truepos.Y, (short)truepos.Z, true, 0, 0, 1, Color.Black));
            ...
            else
            {
                ...
                CurrentScene.Rooms[RoomList.SelectedIndex].AdditionalLights.Add(new ZAdditionalLight((short)CenterPoint.X, (short)CenterPoint.Y, (short)CenterPoint.Z, true, 0, 0, 1, Color.Black)
                );
            }
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && short.MaxValue - Math.Abs(AdditionalLightXPos.Value) > 20)
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && short.MaxValue - Math.Abs(AdditionalLightYPos.Value) > 20)
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && short.MaxValue - Math.Abs(AdditionalLightZPos.Value) > 20)
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && short.MaxValue - Math.Abs(CutsceneAbsolutePositionX.Value) > 20)
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && short.MaxValue - Math.Abs(CutsceneAbsolutePositionY.Value) > 20)
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && short.MaxValue - Math.Abs(CutsceneAbsolutePositionZ.Value) > 20)
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && short.MaxValue - Math.Abs(CutscenePositionXFocus.Value) > 20)
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && short.MaxValue - Math.Abs(CutscenePositionYFocus.Value) > 20)
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && short.MaxValue - Math.Abs(CutscenePositionZFocus.Value) > 20)
        ...
        private void TimeSpeed_Leave(object sender, EventArgs e)
        {
            if (CurrentScene.Rooms.Count > 0)
            {
                CurrentScene.Rooms[RoomList.SelectedIndex].TimeSpeed = (byte)TimeSpeed.Value;
            }
        }
        ...
        {
            if (CurrentScene != null)
                CurrentScene.Rooms[RoomList.SelectedIndex].Echo = (byte)SoundEcho.Value;
        }
        ...
        private void WindWest_Leave(object sender, EventArgs e)
        {
            if (CurrentScene.Rooms.Count > 0)
            {
                CurrentScene.Rooms[RoomList.SelectedIndex].WindWest = (byte)WindWest.Value;
            }
        }
        ...
        private void WindSouth_Leave(object sender, EventArgs e)
        {
            if (CurrentScene.Rooms.Count > 0)
            {
                CurrentScene.Rooms[RoomList.SelectedIndex].WindSouth = (byte)WindSouth.Value;
            }
        }
        ...
        private void WindVertical_Leave(object sender, EventArgs e)
        {
            if (CurrentScene.Rooms.Count > 0)
            {
                CurrentScene.Rooms[RoomList.SelectedIndex].WindVertical = (byte)WindVertical.Value;
            }
        }
        ...
        private void WindStrength_Leave(object sender, EventArgs e)
        {
            if (CurrentScene.Rooms.Count > 0)
            {
                CurrentScene.Rooms[RoomList.SelectedIndex].WindStrength = (byte)WindStrength.Value;
            }
        }
        ...
        public void SetActorFromDatabase(ushort number, ushort variable, byte target)
        {
            if (CurrentScene != null)
            {
                if (actorpick == _Actor_ && CurrentScene.Rooms.Count > 0 && actorEditControl.ActorComboBox.SelectedIndex > -1 && actorEditControl.ActorComboBox.SelectedIndex < CurrentScene.Rooms[RoomList.SelectedIndex].ZActors.Count)
                {
                    StoreUndo(_Actor_);
                    CurrentScene.Rooms[RoomList.SelectedIndex].ZActors[actorEditControl.ActorComboBox.SelectedIndex].Number = number;
                    CurrentScene.Rooms[RoomList.SelectedIndex].ZActors[actorEditControl.ActorComboBox.SelectedIndex].Variable = variable;
                    actorEditControl.UpdateActorEdit();

                }
                else if (actorpick == _Transition_ && transitionEditControl.ActorComboBox.SelectedIndex  > -1 && transitionEditControl.ActorComboBox.SelectedIndex < CurrentScene.Transitions.Count)
                {
                    StoreUndo(_Transition_);
                    CurrentScene.Transitions[transitionEditControl.ActorComboBox.SelectedIndex].Number = number;
                    CurrentScene.Transitions[transitionEditControl.ActorComboBox.SelectedIndex].Variable = variable;
                    transitionEditControl.UpdateActorEdit();
                }
                else if (actorpick == _Spawn_ && spawnerEditControl.ActorComboBox.SelectedIndex > -1 && spawnerEditControl.ActorComboBox.SelectedIndex < CurrentScene.SpawnPoints.Count)
                {
                    StoreUndo(_Spawn_);
                    CurrentScene.SpawnPoints[spawnerEditControl.ActorComboBox.SelectedIndex].Number = number;
                    CurrentScene.SpawnPoints[spawnerEditControl.ActorComboBox.SelectedIndex].Variable = variable;
                    spawnerEditControl.UpdateActorEdit();
                }
            }
        }
            ...
            while (offset < CutsceneBinaryData.Count - 1)
            {
                ...
                else if ((marker == 0x0002 || marker == 0x0006))
                {
                    ...
                    while (1 == 1)
                    {
                        ...
                        ZCutscenePosition cutpos = new ZCutscenePosition((sbyte)CutsceneBinaryData[offset + 1], Helpers.Read16(CutsceneBinaryData, offset + 2), BitConverter.ToSingle(BitConverter.GetBytes(Helpers.Read32(CutsceneBinaryData, offset + 4)), 0), new Vector3(), pos);
        ...
        private void glControl1_MouseWheel(object sender, MouseEventArgs e)
        {
            ...
            if (actorpick == 1 && actorEditControl.ActorNumber != -1)
                target = CurrentScene.Rooms[RoomList.SelectedIndex].ZActors[actorEditControl.ActorNumber];
            else if (actorpick == 2 && transitionEditControl.ActorNumber != -1)
                target = CurrentScene.Transitions[transitionEditControl.ActorNumber];
            else if (actorpick == 3 && spawnerEditControl.ActorNumber != -1)
                target = CurrentScene.SpawnPoints[spawnerEditControl.ActorNumber];
            else if (actorpick == 5 && CurrentScene.Waterboxes.Count > 0)
                target = CurrentScene.Waterboxes[(int)WaterboxSelect.Value];
            else if (actorpick == _CutsceneActor_ && CurrentScene.Cutscene.Count > 0 && CurrentScene.Cutscene[MarkerSelect.SelectedIndex].CutsceneActors.Count > 0)
                target = CurrentScene.Cutscene[MarkerSelect.SelectedIndex].CutsceneActors[CutsceneActorListBox.SelectedIndex];
            ...
            if (actorpick <= 3 && target != null)
            {
                ...
                actorEditControl.UpdateActorEdit_Faster();
                transitionEditControl.UpdateActorEdit_Faster();
                spawnerEditControl.UpdateActorEdit_Faster();
            }
            else if (actorpick == 5 && target != null)
            {
            ...
            else if (actorpick == _CutsceneActor_ && target != null)
            {
                
                float newrot = ((ZCutsceneActor)target).Rotation.Y + (e.Delta * 4);
                if (newrot < -32767) newrot = 32767;
                else if (newrot > 32767) newrot = -32767;
                ((ZCutsceneActor)target).Rotation = new Vector3(((ZCutsceneActor)target).Rotation.X, newrot, ((ZCutsceneActor)target).Rotation.Z);
        ...
        private void SwapGame()
        {
            ...
            actorEditControl.cacheId = 0xFEFE;
            transitionEditControl.cacheId = 0xFEFE;
            spawnerEditControl.cacheId = 0xFEFE;
            actorEditControl.UpdateActorEdit();
            transitionEditControl.UpdateActorEdit();
            spawnerEditControl.UpdateActorEdit();
        }
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && short.MaxValue - Math.Abs(CameraXPos.Value) > 20)
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && short.MaxValue - Math.Abs(CameraYPos.Value) > 20)
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && short.MaxValue - Math.Abs(CameraZPos.Value) > 20)
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && short.MaxValue - Math.Abs(CameraXRot.Value) > 1820)
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && short.MaxValue - Math.Abs(CameraYRot.Value) > 1820)
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && short.MaxValue - Math.Abs(CameraZRot.Value) > 1820)
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && short.MaxValue - Math.Abs(CameraFov.Value) > 20)
        ...
        public ZScene SetSceneHeader(int id, ZScene zscene, ZScene normalheader)
        {
            ...
            {
                int tmpid = zscene.cloneid;
                if (tmpid == 0) return zscene;
                TransferSceneValues(zscene, normalheader);
                zscene = normalheader;
            }
            return zscene;
        }
        ...
        private void AddSceneHeaderButton_Click(object sender, EventArgs e)
        {
            ...
            actorEditControl.SetActors(ref NormalHeader.Rooms[RoomList.SelectedIndex].ZActors);
            actorEditControl.UpdateActorEdit();
            transitionEditControl.SetActors(ref NormalHeader.Transitions);
            transitionEditControl.UpdateActorEdit();
            spawnerEditControl.SetActors(ref NormalHeader.SpawnPoints);
            spawnerEditControl.UpdateActorEdit();
            UpdateEnvironmentData();
            UpdateForm();
        }
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && short.MaxValue - Math.Abs(CutsceneActorXRot.Value) > 1820)
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && short.MaxValue - Math.Abs(CutsceneActorYRot.Value) > 1820)
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && short.MaxValue - Math.Abs(CutsceneActorZRot.Value) > 1820)
        ...
        private bool importEnvironments(List<byte> data, int i, ref ZScene zscene)
        {
            ...
            if ((test & 0xFF00FFFF) == 0x0F000000)
            {
                ...
                for (i = offset; i < offset + (22 * lightcount); i += 22)
                {
                    ...
                    zscene.Environments.Add(new ZEnvironment(lightA, lightB, lightC, lightD, lightE, fogcol, fogdist, drawdist, fogunknown));
                }
        ...
        private void importActorsObjects(List<byte> data, int i, ref ZScene zscene, int room)
        {
            uint test = Helpers.Read32(data, i);
            if ((test & 0xFF00FFFF) == 0x01000000 && data[i + 4] == 0x03)
            {
                ...
                for (int ii = offset; ii < offset + (16 * actorcount); ii += 16)
                {
                    ...
                    zscene.Rooms[room].ZActors.Add(new ZActor(num, xpos, ypos, zpos, xrot, yrot, zrot, var));
                }
            }
            else if ((test & 0xFF00FFFF) == 0x0B000000 && data[i + 4] == 0x03)
            {
                ...
                for (int ii = offset; ii < offset + (2 * objectcount); ii += 2)
                {
                    ...
                    zscene.Rooms[room].ZObjects.Add(new ZScene.ZUShort(obj));
                }
            }
        ...
        private void importEnvironmentsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog1.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                for (int i = 0; i < data.Count; i += 4)
                {
                    ...
                    if (importEnvironments(data, i, ref CurrentScene))
                    {
        ...
        private void importActorsAndObjectsOfZmapToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog1.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                for (int i = 0; i < data.Count; i += 4)
                {
                    ...
                    importActorsObjects(data, i, ref CurrentScene, RoomList.SelectedIndex);
        ...
        private void SceneHeaderSelector_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (RoomList.SelectedIndex != -1) actorEditControl.SetActors(ref CurrentScene.Rooms[RoomList.SelectedIndex].ZActors);
            actorEditControl.UpdateActorEdit();
            transitionEditControl.SetActors(ref CurrentScene.Transitions);
            transitionEditControl.UpdateActorEdit();
            spawnerEditControl.SetActors(ref CurrentScene.SpawnPoints);
        ...
        private void removeAllRomScenesToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                RemoveAllZ64romScenes(rom64.getPath());
        ...
        private void RemoveAllZ64romScenes(string path)
        {
            System.IO.DirectoryInfo di = new DirectoryInfo(path + "\\rom\\scene\\.vanilla");
        ...
        private void importCamerasWaterboxes(List<byte> data, int y, ref ZScene zscene)
        {
            ...
            if ((test & 0xFF00FFFF) == 0x03000000)
            {
                ...
                if (waterboxoffset != 0)
                {
                    ...
                    for (int i = waterboxoffset; i < waterboxoffset + (0x10 * waternum); i += 0x10)
                    {
                        ...
                        zscene.Waterboxes.Add(waterbox);
                        waterboxes++;
                    }
                }
                ...
                if (cameraoffset != 0 && !settings.MajorasMask)
                {
                    ...
                    for (int i = cameraoffset; i < cameraoffset + (0x8 * cameranum); i += 0x8)
                    {
                        ...
                        if (camera.Type == 0x1E && !settings.MajorasMask)
                        {
                            if (settings.SixPointCrawlSpace)
                            {
                            ...
                            {
                                camera.XPos = Helpers.Read16S(data, offset + 6);
                                camera.YPos = Helpers.Read16S(data, offset + 8);
                                camera.ZPos = Helpers.Read16S(data, offset + 10);
                                camera.XRot = Helpers.Read16S(data, offset + 0x18);
                                camera.YRot = Helpers.Read16S(data, offset + 0x1A);
                                camera.ZRot = Helpers.Read16S(data, offset + 0x1C);
                            }
                        }

                        //jfif id

                        zscene.Cameras.Add(camera);
                        cameras++;
                    }
                }
        ...
        private void importCamerasAndWaterboxFromzsceneToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog1.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                for (int y = 0; y < data.Count; y += 4)
                {
                    ...
                    importCamerasWaterboxes(data, y, ref CurrentScene);

                    if (settings.MajorasMask) importMMCameras(data, y, ref CurrentScene);
        ...
        private void importTransitionsSpawns(List<byte> data, int i, ref ZScene zscene)
        {
            uint test = Helpers.Read32(data, i);
            if ((test & 0xFF00FFFF) == 0x0E000000 && data[i + 4] == 0x02)
            {
                ...
                for (int ii = offset; ii < offset + (16 * actorcount); ii += 16)
                {
                    ...
                    zscene.Transitions.Add(new ZActor(frontroom, frontcamera, backroom, backcamera, num, xpos, ypos, zpos, yrot, var));
                }
            }
            else if ((test & 0xFF00FFFF) == 0x00000000 && data[i + 4] == 0x02)
            {
                ...
                for (int ii = offset; ii < offset + (16 * actorcount); ii += 16)
                {
                    ...
                    zscene.SpawnPoints.Add(new ZActor(num, xpos, ypos, zpos, xrot, yrot, zrot, var));
                }
            }
        }
        ...
        private void importTransitionsAndSpawnsFromzsceneToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog1.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                for (int i = 0; i < data.Count; i += 4)
                {
                    importTransitionsSpawns(data, i, ref CurrentScene);
        ...
        private void importPathways(List<byte> data, int y, ref ZScene zscene)
        {
            uint test = Helpers.Read32(data, y);
        ...
        private void importPathwaysFromzsceneToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog1.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                for (int y = 0; y < data.Count; y += 4)
                {
                    importPathways(data, y, ref CurrentScene);
                    uint test = Helpers.Read32(data, y);
        ...
        private void importActorCutscenes(List<byte> data, int y, ref ZScene zscene)
        {
            uint test = Helpers.Read32(data, y);
            ...
            if ((test & 0xFF000000) == 0x1B000000 && (test2 & 0xFF000000) == 0x02000000)
            {
                ...
                for (int i = 0; i < actorcutscenes; i++)
                {
                    ...
                    zscene.ActorCutscenes.Add(actorcs);
                    arrayoffset += 0x10;
                }
            }
        ...
        private void importMMCameras(List<byte> data, int y, ref ZScene zscene)
        {
            uint test = Helpers.Read32(data, y);
            uint test2 = Helpers.Read32(data, y+4);
        ...
        private void importActorCutscenesFromzsceneToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog1.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                for (int y = 0; y < data.Count; y += 4)
                {
                    importActorCutscenes(data, y, ref CurrentScene);
                    uint test = Helpers.Read32(data, y);
        ...
        public string GenerateFlagLog()
        {
            ...
            if (ActorCache.Count == 0) RefreshActorCache();
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && ushort.MaxValue - Math.Abs(CameraUnk1.Value) > 1820)
                CameraUnk1.Value += (CameraUnk1.Value - (short)CurrentScene.Cameras[(int)CameraSelect.Value].Unk1) * 9;

            CurrentScene.Cameras[(int)CameraSelect.Value].Unk1 = (ushort)((short)CameraUnk1.Value & 0xFFFF);
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && ushort.MaxValue - Math.Abs(CameraUnk2.Value) > 1820)
                CameraUnk2.Value += (CameraUnk2.Value - (short)CurrentScene.Cameras[(int)CameraSelect.Value].Unk2) * 9;

            CurrentScene.Cameras[(int)CameraSelect.Value].Unk2 = (ushort)((short)CameraUnk2.Value & 0xFFFF);
        ...
        private ZScene LoadZsceneData(List<byte> data, int sceneid = -1, bool ignoremesh = false)
        {
            ...
            returnScene.Environments.Clear();
            returnScene.SpawnPoints.Clear();
            returnScene.Transitions.Clear();
            returnScene.Pathways.Clear();
            returnScene.Waterboxes.Clear();

            returnScene.PregeneratedMesh = true;
            ...
            returnScene.OriginalSceneData = new List<byte>(data);
            ...
            if (Helpers.Read32(data, 0) == 0x18000000)
            {
                ...
                while (offset < data.Count)
                {
                    ...
                    if ((data[offset] == 0x02 || Helpers.Read32(data, offset) == 0) && test < data.Count)
                    {
                        ...
                        returnScene.SceneHeaders.Add(new ZSceneHeader(data[offset] != 0x02, clone));
                    ...
                    for (int y = (int)headeroffset; y < data.Count; y += 4)
                    {
                        ...
                        if (!collision)
                        {
                            ...
                            if (objfile != null)
                            {
                                ...
                                returnScene.CollisionFilename = colfilename;

                                importCamerasWaterboxes(data, y, ref returnScene);
                            }

                        }

                        if (returnScene.Transitions.Count == 0 || returnScene.SpawnPoints.Count == 0) importTransitionsSpawns(data, y, ref returnScene);
                        if (returnScene.Waterboxes.Count == 0 || returnScene.Cameras.Count == 0) importCamerasWaterboxes(data, y, ref returnScene);
                        if (returnScene.Environments.Count == 0) importEnvironments(data, y, ref returnScene);
                        if (returnScene.Pathways.Count == 0) importPathways(data, y, ref returnScene);
                        ...
                        if (!command15 && ((test & 0xFF00FFFF) == 0x15000000 && Helpers.Read16(data, y + 4) == 0))
                        {
                            command15 = true;
                            //unknown = data[y + 1];
                            returnScene.NightSFX = data[y + 6];
                            returnScene.Music = data[y + 7];
                        ...
                        if ((!command13 && ((test & 0xFFFFFFFF) == 0x13000000 && data[y + 4] == 0x02)) || (collision && exitcommandoffset > 0 && !command13))
                        {
                            ...
                            foreach (ObjFile.Group Group in returnScene.ColModel.Groups)
                            {
                                ulong polytype = 0;
                                ...
                                int polyid = returnScene.PolyTypes.FindIndex(x => x.Raw == polytype && x.PolyFlagA == polyflags && x.PolyFlagB == polyflagsB);
                                if (polyid == -1)
                                {
                                    returnScene.PolyTypes.Add(new ZColPolyType(polytype, polyflags, polyflagsB));
                        ...
                        if (!command11 && ((test & 0xFFFFFFFF) == 0x11000000 && data[y + 7] == 0))
                        {
                            ...
                            returnScene.SkyboxType = data[y + 4];
                            returnScene.Cloudy = data[y + 5] == 1;
                            returnScene.OutdoorLight = data[y + 6] == 0;
                        ...
                        if (!command7 && ((test & 0xFF00FFFF) == 0x07000000 && Helpers.Read16(data, y + 4) == 0))
                        {
                            ...
                            returnScene.ElfMessage = data[y + 1];
                            returnScene.SpecialObject = Helpers.Read16(data, y + 6);
                        ...
                        if (!command19 && ((test & 0xFF00FFFF) == 0x19000000 && Helpers.Read16(data, y + 4) == 0))
                        {
                            ...
                            returnScene.CameraMovement = data[y + 1];
                            returnScene.WorldMap = data[y + 7];
            ...
            for (int r = 0; r < roomcount; r++)
            {
                ...
                returnScene.AddRoom(currentroom);
                DebugConsole.WriteLine("Added room " + currentroom + " r " + r);

                foreach (ZSceneHeader header in returnScene.SceneHeaders)
                {
                ...
                /*
                ((CurrencyManager)RoomList.BindingContext[returnScene.Rooms]).Refresh();



                if (returnScene.Rooms.Count != RoomList.Items.Count)
                {


                    MessageBox.Show("Header missmatch", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);

                    DebugConsole.WriteLine(returnScene.Rooms.Count);
                ...
                */
                ...
                returnScene.Rooms[r].OriginalRoomData = new List<byte>(data);
                ...
                foreach (uint headeroffset in headeroffsets)
                {
                    ...
                    if (cnt == 0 || headeroffset != 0)
                    {
                        ...
                        for (int y = (int)headeroffset; y < data.Count; y += 4)
                        {
                            ...
                            if (returnScene.Rooms[r].ZActors.Count == 0 || returnScene.Rooms[r].ZObjects.Count == 0) importActorsObjects(data, y, ref returnScene, r);
                            ...
                            if (!command5 && ((test & 0xFFFFFFFF) == 0x05000000))
                            {
                                ...
                                returnScene.Rooms[r].WindWest = data[y + 4];
                                returnScene.Rooms[r].WindVertical = data[y + 5];
                                returnScene.Rooms[r].WindSouth = data[y + 6];
                                returnScene.Rooms[r].WindStrength = data[y + 7];
                            ...
                            if (!command8 && ((test & 0xFFFFFFFF) == 0x08000000 && data[y + 4] == 0x00))
                            {
                                ...
                                returnScene.Rooms[r].Restriction = data[y + 1];
                                returnScene.Rooms[r].DisableWarpSongs = ((data[y + 6] & 0xF0) >> 4 == 1);
                                returnScene.Rooms[r].ShowInvisibleActors = ((data[y + 6] & 0x0F) == 1);
                                returnScene.Rooms[r].IdleAnim = data[y + 7];
                            ...
                            if (!commandC && ((test & 0xFF00FFFFF) == 0x0C000000 && data[y + 4] == 0x03))
                            {
                                ...
                                for (int i = unusedlightsoffset; i < unusedlightsoffset + lightcount * 14; i += 14)
                                {
                                    ...
                                    returnScene.Rooms[r].AdditionalLights.Add(light);
                                }
                            ...
                            if (!command10 && ((test & 0xFFFFFFFF) == 0x10000000))
                            {
                                ...
                                returnScene.Rooms[r].StartTime = Helpers.Read16(data, y + 4);
                                returnScene.Rooms[r].TimeSpeed = data[y + 6];
                            ...
                            if (!command12 && ((test & 0xFFFFFFFF) == 0x12000000))
                            {
                                ...
                                returnScene.Rooms[r].DisableSkybox = data[y + 4] == 1;
                                returnScene.Rooms[r].DisableSunMoon = data[y + 5] == 1;
                            ...
                            if (!command16 && ((test & 0xFFFFFFFF) == 0x16000000))
                            {
                                ...
                                returnScene.Rooms[r].Echo = data[y + 7];
                            ...
                            if (!ignoremesh && !commandA && ((test & 0xFFFFFFFF) == 0x0A000000 && data[y + 4] == 0x03))
                            {
                                commandA = true;

                                returnScene.Rooms[r].OriginalMeshHeaderOffset = (int)Helpers.Read24(data, y + 5);
                                ...
                                if (data[meshoffset] == 1 && r == 0) //room 0 only
                                {
                                    ...
                                    if (data[meshoffset + 1] == 0x1) // single background
                                    {
                                        ...
                                        if (endofimage != 0)
                                        {
                                            ...
                                            returnScene.prerenderimages.Add(filename);
        ...
        private void CameraCopyViewport_Click(object sender, EventArgs e)
        {
            ...
            if (!(!settings.MajorasMask && CurrentScene.Cameras[(int)CameraSelect.Value].Type == 0x1E))
            {
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && ushort.MaxValue - Math.Abs(CameraUnk12.Value) > 20)
                CameraUnk12.Value += (CameraUnk12.Value - (short)CurrentScene.Cameras[(int)CameraSelect.Value].Unk12) * 19;

            CurrentScene.Cameras[(int)CameraSelect.Value].Unk12 = (ushort)((short)CameraUnk12.Value & 0xFFFF);
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && ushort.MaxValue - Math.Abs(CameraUnk14.Value) > 20)
                CameraUnk14.Value += (CameraUnk14.Value - (short)CurrentScene.Cameras[(int)CameraSelect.Value].Unk14) * 19;

            CurrentScene.Cameras[(int)CameraSelect.Value].Unk14 = (ushort)((short)CameraUnk14.Value & 0xFFFF);
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && ushort.MaxValue - Math.Abs(CameraUnk16.Value) > 20)
                CameraUnk16.Value += (CameraUnk16.Value - (short)CurrentScene.Cameras[(int)CameraSelect.Value].Unk16) * 19;

            CurrentScene.Cameras[(int)CameraSelect.Value].Unk16 = (ushort)((short)CameraUnk16.Value & 0xFFFF);
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && ushort.MaxValue - Math.Abs(CameraUnk18.Value) > 20)
                CameraUnk18.Value += (CameraUnk18.Value - (short)CurrentScene.Cameras[(int)CameraSelect.Value].Unk18) * 19;

            CurrentScene.Cameras[(int)CameraSelect.Value].Unk18 = (ushort)((short)CameraUnk18.Value & 0xFFFF);
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && ushort.MaxValue - Math.Abs(CameraUnk1A.Value) > 20)
                CameraUnk1A.Value += (CameraUnk1A.Value - (short)CurrentScene.Cameras[(int)CameraSelect.Value].Unk1A) * 19;

            CurrentScene.Cameras[(int)CameraSelect.Value].Unk1A = (ushort)((short)CameraUnk1A.Value & 0xFFFF);
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && ushort.MaxValue - Math.Abs(CameraUnk1C.Value) > 20)
                CameraUnk1C.Value += (CameraUnk1C.Value - (short)CurrentScene.Cameras[(int)CameraSelect.Value].Unk1C) * 19;

            CurrentScene.Cameras[(int)CameraSelect.Value].Unk1C = (ushort)((short)CameraUnk1C.Value & 0xFFFF);
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && ushort.MaxValue - Math.Abs(CameraUnk1E.Value) > 20)
                CameraUnk1E.Value += (CameraUnk1E.Value - (short)CurrentScene.Cameras[(int)CameraSelect.Value].Unk1E) * 19;

            CurrentScene.Cameras[(int)CameraSelect.Value].Unk1E = (ushort)((short)CameraUnk1E.Value & 0xFFFF);
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && ushort.MaxValue - Math.Abs(CameraUnk20.Value) > 20)
                CameraUnk20.Value += (CameraUnk20.Value - (short)CurrentScene.Cameras[(int)CameraSelect.Value].Unk20) * 19;

            CurrentScene.Cameras[(int)CameraSelect.Value].Unk20 = (ushort)((short)CameraUnk20.Value & 0xFFFF);
        ...
        {
            if (((ModifierKeys & Keys.Shift) != 0) && ushort.MaxValue - Math.Abs(CameraUnk22.Value) > 20)
                CameraUnk22.Value += (CameraUnk22.Value - (short)CurrentScene.Cameras[(int)CameraSelect.Value].Unk22) * 19;

            CurrentScene.Cameras[(int)CameraSelect.Value].Unk22 = (ushort)((short)CameraUnk22.Value & 0xFFFF);
        ...
        {
            ((ObjFile.Group)GroupList.SelectedItem).ScaledNormals = GroupScaledNormals.Checked;
        ...
        private void NewZ64romProject_Click(object sender, EventArgs e)
        {
            ...
            if (saveFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                if (openFileDialog1.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                {
                    ...
                    if (cmd.ExitCode == 0) //ExecuteZ64Rom("--auto-install --no-wait")
                    {
                    ...
                    {
                        MessageBox.Show("Seems the installation failed. Perhaps you're using a bad rom?", "Error", MessageBoxButtons.OK,MessageBoxIcon.Error);
                    }
        ...
        private void Z64RomPlay_Click(object sender, EventArgs e)
        {
            if (CurrentScene == null || CurrentScene.Rooms.Count == 0)
            {
                MessageBox.Show("You need to create a scene in order to try it ingame...", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            if (rom64.isSet())
            {
                buildAndLaunchZ64romWarpToSceneToolStripMenuItem_Click(sender, e);
            }
            else
            {
                injectToROMToolStripMenuItem_Click(sender, e);
                LaunchRomToolStripMenuItem_Click(sender, e);
        ...
        {
            if (CurrentScene != null & CurrentScene.Rooms.Count > 0 & CurrentScene.Rooms[RoomList.SelectedIndex].ZActors.Count > 0 && spawnerEditControl.ActorComboBox.SelectedIndex != -1)
            {
                tomlconversionID = CurrentScene.Rooms[RoomList.SelectedIndex].ZActors[spawnerEditControl.ActorComboBox.SelectedIndex].Number;
        ...
        {
            if (FaroresPlugin.AddLinkAnimations(rom64.getPath(),false) == "")
            {
        ...
        private void convertAllincpngFilesInTheProjectToBinaryz64romToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (rom64.isSet())
            {
                string result = FaroresPlugin.ConvertAllIncPngFiles(rom64.getPath());
        ...
        private void createDMAFilesFromFoldersz64romToolStripMenuItem_Click(object sender, EventArgs e)
        {
            string result = FaroresPlugin.CustomDMAEntries(rom64.getPath(),false);
            if (result.Contains("Done!"))
            {
                MessageBox.Show(result, "Done", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        ...
        private void CameraMoveAllPoints_Click(object sender, EventArgs e)
        {
            ZCamera target = CurrentScene.Cameras[(int)CameraSelect.Value];
            target.XRot = target.XPos;
            target.YRot = (short) (target.YPos+20);
            target.ZRot = target.ZPos;
            target.Fov = target.XPos;
            target.Unk1 = (ushort)((short)(target.YPos + 40)&0xFFFF);
            target.Unk2 = (ushort)((short)(target.ZPos) & 0xFFFF);
            target.Unk12 = (ushort)((short)(target.XPos) & 0xFFFF);
            target.Unk14 = (ushort)((short)(target.YPos + 60) & 0xFFFF);
            target.Unk16 = (ushort)((short)(target.ZPos) & 0xFFFF);
            target.Unk18 = (ushort)((short)(target.XPos) & 0xFFFF);
            target.Unk1A = (ushort)((short)(target.YPos + 80) & 0xFFFF);
            target.Unk1C = (ushort)((short)(target.ZPos) & 0xFFFF);
            target.Unk1E = (ushort)((short)(target.XPos) & 0xFFFF);
            target.Unk20 = (ushort)((short)(target.YPos + 100) & 0xFFFF);
            target.Unk22 = (ushort)((short)(target.ZPos) & 0xFFFF);
        }
                ...
                using (MoveActorToRoom moveactor = new MoveActorToRoom())
                {
                    if (moveactor.ShowDialog() == DialogResult.OK)
                    {
                        ...
                        else
                        {
                            ...
                            CurrentScene.Rooms[targetroom].ZActors.Add(CurrentScene.Rooms[RoomList.SelectedIndex].ZActors[actorEditControl.ActorNumber].Clone());
                            actorEditControl.DeleteActor();
                            actorEditControl.UpdateActorEdit();
                            UpdateForm();
        ...
        private void publicReleaseDebugFeaturesOffreleaseToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (rom64.isSet())
            {
                ...
                bool compress = false;
                if (MessageBox.Show("Compress the rom? A compressed rom's files will use less space, but loadings will be slower", "Warning",
                MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) == DialogResult.Yes)
                {
                    compress = true;
                }
        ...
        private void importDataFromROMzscenezroomxmlToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (CurrentScene != null && CurrentScene.Rooms.Count > 0)
            {
                ...
                if (openFileDialog1.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                {
                    ...
                    else if (extension.ToLower() == ".z64")
                    {
                        ...
                        using (OpenRomScene openromscene = new OpenRomScene(data))
                        {
                            if (openromscene.ShowDialog() == DialogResult.OK)
                            {
                                int sceneid = openromscene.sceneid;

                                MainScene = LoadZsceneData(data, sceneid, true);
                            }
                            else return;
                        }
                ...
                using (ImportDataFromFile window = new ImportDataFromFile(maxrooms,maxheaders, filename, CurrentScene.Rooms.Count == maxrooms, CurrentScene.SceneHeaders.Count == maxheaders))
                {
                    if (window.ShowDialog() == DialogResult.OK)
                    {
                        ...
                        if (window.cameras)
                        {
                            CurrentScene.Cameras = TargetScene.Cameras.ConvertAll(x => (x.Clone())); 
                        }
                        if (window.exits)
                        {
                            CurrentScene.ExitList = TargetScene.ExitList.ConvertAll(x => (x.Clone()));
                            CurrentScene.ExitListV2 = TargetScene.ExitListV2.ConvertAll(x => (x.Clone()));
                        }
                        if (window.waterboxes)
                        {
                            CurrentScene.Waterboxes = TargetScene.Waterboxes.ConvertAll(x => (x.Clone()));
                        }
                        if (window.pathways)
                        {
                            CurrentScene.Pathways = TargetScene.Pathways.ConvertAll(x => (x.Clone()));
                        }
                        if (window.transitions)
                        {
                            CurrentScene.Transitions = TargetScene.Transitions.ConvertAll(x => (x.Clone()));
                            transitionEditControl.SetActors(ref CurrentScene.Transitions);
                        }
                        if (window.spawns)
                        {
                            CurrentScene.SpawnPoints = TargetScene.SpawnPoints.ConvertAll(x => (x.Clone()));
                            spawnerEditControl.SetActors(ref CurrentScene.SpawnPoints);
                        }
                        if (window.environments)
                        {
                            CurrentScene.Environments = TargetScene.Environments.ConvertAll(x => (x.Clone()));
                            CurrentScene.OutdoorLight = TargetScene.OutdoorLight;
                        }
                        if (window.actors)
                        {
                            if (window.allrooms)
                            {
                                ...
                                {
                                    CurrentScene.Rooms[i].ZActors = TargetScene.Rooms[i].ZActors.ConvertAll(x => (x.Clone()));
                                }
                            }
                            else
                                CurrentScene.Rooms[RoomList.SelectedIndex].ZActors = TargetScene.Rooms[window.room].ZActors.ConvertAll(x => (x.Clone()));
                        ...
                        if (window.objects)
                        {
                            if (window.allrooms)
                            {
                                for (int i = 0; i < maxrooms; i++)
                                {
                                    CurrentScene.Rooms[i].ZObjects = TargetScene.Rooms[i].ZObjects.ConvertAll(x => (x.Clone()));
                                }
                            }
                            else
                                CurrentScene.Rooms[RoomList.SelectedIndex].ZObjects = TargetScene.Rooms[window.room].ZObjects.ConvertAll(x => (x.Clone()));
                        }
                        if (window.cutscene)
                        {
                            CurrentScene.Cutscene = TargetScene.Cutscene.ConvertAll(x => (x.Clone()));
                        }
                        if (window.textureanimations)
                        {
                            CurrentScene.TextureAnims = TargetScene.TextureAnims.ConvertAll(x => (x.Clone()));
                        }
                        if (window.actorcutscenes)
                        {
                            CurrentScene.ActorCutscenes = TargetScene.ActorCutscenes.ConvertAll(x => (x.Clone()));
                        }
                        if (window.scenesettings)
                        {
                            CurrentScene.Music = TargetScene.Music;
                            CurrentScene.NightSFX = TargetScene.NightSFX;
                            CurrentScene.Reverb = TargetScene.Reverb;
                            CurrentScene.CameraMovement = TargetScene.CameraMovement;
                            CurrentScene.Cloudy = TargetScene.Cloudy;
                            CurrentScene.Skybox = TargetScene.Skybox;
                            CurrentScene.SkyboxType = TargetScene.SkyboxType;
                            CurrentScene.RestrictionFlags = TargetScene.RestrictionFlags;
                            CurrentScene.SpecialObject = TargetScene.SpecialObject;
                            CurrentScene.WorldMap = TargetScene.WorldMap;
                        }
                        if (window.additionaltextures)
                        {
                            CurrentScene.AdditionalTextures = TargetScene.AdditionalTextures.ConvertAll(x => (x.Clone()));
                        }
                        if (window.roomsettings)
                        {
                            if (window.allrooms)
                            {
                                for (int i = 0; i < maxrooms; i++)
                                {
                                    CurrentScene.Rooms[i].StartTime = TargetScene.Rooms[i].StartTime;
                                    CurrentScene.Rooms[i].TimeSpeed = TargetScene.Rooms[i].TimeSpeed;
                                    CurrentScene.Rooms[i].ShowInvisibleActors = TargetScene.Rooms[i].ShowInvisibleActors;
                                    CurrentScene.Rooms[i].Restriction = TargetScene.Rooms[i].Restriction;
                                    CurrentScene.Rooms[i].IdleAnim = TargetScene.Rooms[i].IdleAnim;
                                    CurrentScene.Rooms[i].WindSouth = TargetScene.Rooms[i].WindSouth;
                                    CurrentScene.Rooms[i].WindStrength = TargetScene.Rooms[i].WindStrength;
                                    CurrentScene.Rooms[i].WindVertical = TargetScene.Rooms[i].WindVertical;
                                    CurrentScene.Rooms[i].WindWest = TargetScene.Rooms[i].WindWest;
                                    CurrentScene.Rooms[i].DisableSunMoon = TargetScene.Rooms[i].DisableSunMoon;
                                    CurrentScene.Rooms[i].DisableSkybox = TargetScene.Rooms[i].DisableSkybox;
                                    CurrentScene.Rooms[i].DisableWarpSongs = TargetScene.Rooms[i].DisableWarpSongs;
                                }
                            }
                            else
                            {
                                CurrentScene.Rooms[RoomList.SelectedIndex].StartTime = TargetScene.Rooms[window.room].StartTime;
                                CurrentScene.Rooms[RoomList.SelectedIndex].TimeSpeed = TargetScene.Rooms[window.room].TimeSpeed;
                                CurrentScene.Rooms[RoomList.SelectedIndex].ShowInvisibleActors = TargetScene.Rooms[window.room].ShowInvisibleActors;
                                CurrentScene.Rooms[RoomList.SelectedIndex].Restriction = TargetScene.Rooms[window.room].Restriction;
                                CurrentScene.Rooms[RoomList.SelectedIndex].IdleAnim = TargetScene.Rooms[window.room].IdleAnim;
                                CurrentScene.Rooms[RoomList.SelectedIndex].WindSouth = TargetScene.Rooms[window.room].WindSouth;
                                CurrentScene.Rooms[RoomList.SelectedIndex].WindStrength = TargetScene.Rooms[window.room].WindStrength;
                                CurrentScene.Rooms[RoomList.SelectedIndex].WindVertical = TargetScene.Rooms[window.room].WindVertical;
                                CurrentScene.Rooms[RoomList.SelectedIndex].WindWest = TargetScene.Rooms[window.room].WindWest;
                                CurrentScene.Rooms[RoomList.SelectedIndex].DisableSunMoon = TargetScene.Rooms[window.room].DisableSunMoon;
                                CurrentScene.Rooms[RoomList.SelectedIndex].DisableSkybox = TargetScene.Rooms[window.room].DisableSkybox;
                                CurrentScene.Rooms[RoomList.SelectedIndex].DisableWarpSongs = TargetScene.Rooms[window.room].DisableWarpSongs;
                            }
            ...
            if (texteditorwebsite == "")
            {
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(json))
                    {
                        ...
                        texteditorwebsite = Helpers.ExtractJsonValue(json, "\"browser_download_url\"");
                    }
            ...
            if (texteditorwebsite != "")
            {
                ...
                if ((!Directory.Exists(ToolDirectory) || !File.Exists(ToolDirectory + "Zelda64 Text Editor.exe")))
                {
                    if (MessageBox.Show("Download zelda64 text editor? (this is only required once)", "Download", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
                    {
                        ...
                        PleaseWait pleasewait = new PleaseWait(texteditorwebsite, zippath, ToolDirectory, true);
                        pleasewait.ShowDialog();
                ...
                else
                {
                    ...
                    if (latestversion > version)
                    {
                        if (MessageBox.Show("Version " + latestversion + " available, update Text Editor to new version?", "Update", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
                        {
                            ...
                            {
                                if (file.Contains(".exe") || file.Contains(".dll"))
                                {
                            ...
                            Directory.CreateDirectory(ToolDirectory);
                            PleaseWait pleasewait = new PleaseWait(texteditorwebsite, zippath, ToolDirectory, true, ExtractExistingFileAction.DoNotOverwrite);
                            pleasewait.ShowDialog();
